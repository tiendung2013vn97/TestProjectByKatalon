...
WebUI.setText(findTestObject('Object Repository/Page_ccommit settings/input_Name_style__StyledInput-sc-17zryot-2 jHXlSy'), 
    'ChangeName')

WebUI.click(findTestObject('Object Repository/Page_ccommit settings/button_Save'))
