...
WebUI.setText(findTestObject('Object Repository/Page_ccommitchange settings/input_Channel Name_name'), 'channel name here')

WebUI.setText(findTestObject('Page_ccommitchange settings/textarea_Describe it in 140 characters or less_slug'), 'describe here')
