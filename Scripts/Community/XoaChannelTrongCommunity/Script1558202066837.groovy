...
WebUI.click(findTestObject('Object Repository/Page_name changed settings/svg_delete'))

WebUI.click(findTestObject('Object Repository/Page_name changed settings/button_Delete'))
