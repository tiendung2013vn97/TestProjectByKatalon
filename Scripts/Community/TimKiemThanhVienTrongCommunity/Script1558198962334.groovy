...
WebUI.setText(findTestObject('Object Repository/Page_ccommitchange settings/input_Blocked_style__SearchInput-sc-1dn98ll-12 hqecpp'), 
    'ngophuochai')

WebUI.sendKeys(findTestObject('Object Repository/Page_ccommitchange settings/input_Blocked_style__SearchInput-sc-1dn98ll-12 hqecpp'), 
